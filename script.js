...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Building full-stack web apps and embedded IoT systems.   ",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor("⚡ Projects", "#ff8c00")}
${this.wrapWithColor(
  "   Built Student Achievement Platform, OCMS, NFCUnlock, SoundWave",
  "#ffffff"
)}
${this.wrapWithColor("   Integrated ESP32, BLE, and NFC/RFID for smart control", "#ff8c00")}

${this.wrapWithColor("⚡ Seeking", "#ff8c00")}
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">💼 Featured Projects</span>

<span style="color: #00ffff;">Student Achievement Platform | Full-Stack</span>
${this.wrapWithColor(
  "Java · Spring Boot · React Vite · MySQL · JWT · RBAC",
  "#ffffff"
)}
• ${this.wrapWithColor("Extracurricular Platform", "#ffa07a")} - ${this.wrapWithColor(
      "Manages extracurricular records and awards for 100+ student entries.",
      "#ffffff"
    )}
• ${this.wrapWithColor("JWT REST API Backend", "#ffa07a")} - ${this.wrapWithColor(
      "Engineered secure two-tier RBAC with zero unauthorized access incidents.",
      "#ffffff"
    )}

<span style="color: #00ffff;">OCMS — Online Course Management System | Frontend</span>
${this.wrapWithColor(
  "React.js · JavaScript ES6+ · HTML5 · CSS3",
  "#ffffff"
)}
• ${this.wrapWithColor("Multi-Role LMS", "#ffa07a")} - ${this.wrapWithColor(
      "Enables educators to publish courses while students enrol and track progress.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Reusable Component Library", "#ffa07a")} - ${this.wrapWithColor(
      "Built with 15+ component reusable library, cutting dev time by ~40%.",
      "#ffffff"
    )}

<span style="color: #00ffff;">NFCUnlock — Smart Vehicle Access Control | Embedded</span>
${this.wrapWithColor(
  "C++ · Arduino IDE · NFC/RFID · Autodesk Tinkercad",
  "#ffffff"
)}
• ${this.wrapWithColor("Hardware Authentication", "#ffa07a")} - ${this.wrapWithColor(
      "NFC/RFID-based vehicle access control system with hardware-level security.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Tinkercad Simulation", "#ffa07a")} - ${this.wrapWithColor(
      "Simulated full circuit logic, reducing build time by ~30%.",
      "#ffffff"
    )}

<span style="color: #00ffff;">SoundWave — Gesture-to-Speech Gloves | Embedded AI</span>
${this.wrapWithColor(
  "C++ · ESP32 · Flex Sensors · BLE Wireless",
  "#ffffff"
)}
• ${this.wrapWithColor("Gesture Classification", "#ffa07a")} - ${this.wrapWithColor(
      "Wearable gloves classifying 10+ gestures at 90%+ accuracy.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Real-Time BLE Transmission", "#ffa07a")} - ${this.wrapWithColor(
      "BLE wireless transmission for &lt;100ms gesture-to-speech conversion.",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("🏛️ Institution:", "#ff8c00")} ${this.wrapWithColor(
      "Army Public School (APS), Ranchi",
      "#ffffff"
    )}
${this.wrapWithColor("📅 Date:", "#ff8c00")}         ${this.wrapWithColor(
      "Graduated Mar 2023",
      "#ffffff"
    )}`;
...
• ${this.wrapWithColor("Languages: Java, JavaScript (ES6+), Python, C, C++, SQL, HTML5, CSS3", "#ffffff")}
• ${this.wrapWithColor("Frontend: React.js, React Vite, HTML5, CSS3, Responsive Design", "#ffffff")}
• ${this.wrapWithColor("Backend: Spring Boot, Node.js, REST APIs, JWT, MVC, RBAC", "#ffffff")}
• ${this.wrapWithColor("Databases & Cloud: MySQL, DBMS, AWS EC2, AWS S3, Postman, Git/GitHub", "#ffffff")}
• ${this.wrapWithColor("Embedded & IoT: Arduino IDE, ESP32, Flex Sensors, NFC/RFID, BLE, Tinkercad", "#ffffff")}
• ${this.wrapWithColor("CS Fundamentals: Data Structures & Algorithms, OOP, OS, Networks, ML", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:nishant1872005@gmail.com" style="color: #ffffff; text-decoration: none;">nishant1872005@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://YOUR_DOMAIN" target="_blank" style="color: #ffffff; text-decoration: none;">YOUR_DOMAIN</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/NISHANT-187" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/NISHANT-187</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/nishant-kumar-a166a3305" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/nishant-kumar-a166a3305</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
    ...
    this.projects = [
      {
        ...
        description: "JWT-secured platform managing records for 100+ students across role-based dashboards.",
        image: "image/social-cover.png",
        technologies: ["Java", "Spring Boot", "React Vite", "MySQL", "JWT", "RBAC"],
        demo: "https://github.com/NISHANT-187",
        repo: "https://github.com/NISHANT-187",
      },
      {
        title: "SoundWave Gloves",
        description: "Gesture-to-speech wearable gloves classifying 10+ gestures using ESP32 & BLE.",
        image: "image/social-cover.png",
        technologies: ["C++", "ESP32", "Flex Sensors", "BLE Wireless"],
        demo: "https://github.com/NISHANT-187",
        repo: "https://github.com/NISHANT-187",
      }
    ];
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "nishant@kumar: ~/interactive-resume";
